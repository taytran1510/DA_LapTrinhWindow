    ...
    public partial class Quanlynhanvien : Form
    {
        ...
        private void btnThem_Click(object sender, EventArgs e)
        {
            ...
            if (txtMaNv.Text.Trim() == "")
                ...
                nvb.insertNV(txtMaNv.Text, txtTenNv.Text, dtpNgaysinh.Value.ToString("dd/MM/yyyy"), txtDiachi.Text, luongnv, cbxPhongban.SelectedValue.ToString(), cbxDuan.SelectedValue.ToString(), cbxPhai.SelectedItem.ToString(), cbcCalamviec.SelectedItem.ToString());
        ...
        private void btnSua_Click(object sender, EventArgs e)
        {
            ...
            if (txtMaNv.Text.Trim() == "")
                ...
                nvb.updateNV(txtMaNv.Text, txtTenNv.Text, dtpNgaysinh.Value.ToString("dd/MM/yyyy"), txtDiachi.Text, luongnv, cbxPhongban.SelectedValue.ToString(), cbxDuan.SelectedValue.ToString(), cbxPhai.SelectedItem.ToString(), cbcCalamviec.SelectedItem.ToString());
            Quanlynhanvien_Load(sender, e);
        }
        ...
        private void dgvNhanVien_CellClick(object sender, DataGridViewCellEventArgs e)
        {
            ...
            if (row >= 0)
            {
                ...
                cbcCalamviec.Text = dgvNhanVien.Rows[row].Cells[8].Value.ToString();
                cbxPhai.Text= dgvNhanVien.Rows[row].Cells[7].Value.ToString();
            }
        }
        ...
        private void dUANBindingSource_CurrentChanged(object sender, EventArgs e)
        {
        ...
        {
            Process.Start("https://lms.hcmute.edu.vn/");
        }

        private void lblMaDa_Click(object sender, EventArgs e)
        {
